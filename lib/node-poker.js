...
Table.prototype.ReplacePlayerAtIndex = function (index, playerName, chips) {
  // make sure to call this only after a game has ended, before starting new game
  if (chips >= this.minBuyIn && chips <= this.maxBuyIn && this.game.roundName === 'River' ) {
      var player = new Player(playerName, chips, this);
